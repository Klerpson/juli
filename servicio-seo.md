...
| 👨🏼‍🏭 SEO MANAGER (**Yo administro y tú ejecutas**) | 🫡 Investigación de palabras clave para tu negocio y gestión del contenido de las páginas principales; optimización de la página web con SEO técnico y on-page; si tienes blog, te enviaré sugerencias del contenido redactado y enlazado, pero tú lo gestionarás; investigación de la competencia; presentación quincenal de informes | 💵 1'255.000 |
| 👨🏼‍🏭 ASESOR SEO | 🫡 Reuniones semanales donde yo hago el trabajo de SEO administrativo, pero el personal de tu empresa ejecuta el plan de trabajo | 💵 895000 mensual |
| 👨🏼‍🏭 REDACCIÓN SEO (**redacción de artículos para tu blog**) | 🫡 Investigación de contenido, análisis de la competencia y creación de estrategia de contenidos (⚠️ Artículos totalmente redactados con técnicas de copywriting y storytelling, sin IA) | 💵 77000 por artículo |
